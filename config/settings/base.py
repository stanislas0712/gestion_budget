...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@gestion-budget.local')
EMAIL_SENDER_NAME = os.environ.get('EMAIL_SENDER_NAME', 'Plateforme de Gestion Budgétaire')
